                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="tel" name="telefonoPaciente" placeholder="Ingrese su número telefónico" maxlength="10" pattern="^\+?\d{1,3}[-\s]?\d{3,4}[-\s]?\d{3,4}$" required>
                            </div>
                        </div>
                        ...
                        <div id="tutorSection" style="display:none;">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="tel" name="telefonoTutor" placeholder="Ingrese el número telefónico de su tutor" maxlength="10" pattern="^\+?\d{1,3}[-\s]?\d{3,4}[-\s]?\d{3,4}$" required>
                                </div>
                                <div class="col">

<%-- 
    Document   : autenticacionPaciente
    Created on : 3 may 2024, 15:29:58
    Author     : magda
--%>
...
<html lang="es">
    ...
    <head>
        ...
        <title>Autenticación Paciente</title>
    ...
    <body>
        ...
        <div class="body-styles">
            ...
            <div class="login-form">
                ...
                <form action="citasPendientes.jsp" method="POST" id="autenticacionForm">

<%-- 
    ...
    Created on : 11 may 2024, 13:16:37
    Author     : march
--%>
        ...
        <div class="body-styles">
            <div class="register-form">
                <div class="botonesExp" style="margin-top: -15px; margin-bottom: 30px;">
                    <button style="background-color: #aeaeae; color: black; width: 200px;" id="regresar-btn" onclick="window.location.href = 'menuMedico.jsp';">Regresar a menú</button>
                </div>
                <form action="ServletExpediente" method="post">
                    ...
                    <div class="botonesExp" style="margin-top: -15px; margin-bottom: 30px;">
                        <button name="EditarExpediente" style="background-color: #aeaeae; color: black; width: 200px;" id="agregar-btn" >Editar</button>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea id="antecedentesHereditarios" placeholder="Ingrese los antecedentes hereditarios del paciente..." name="antecedentesHereditarios" rows="4" cols="50"><%= expedienteEncontrado.getAntecedentesHereditarios()%></textarea>
                            </div>
                            <div class="col">
                                <label for="padecimientosPersonales">Padecimientos Personales:</label>
                                <textarea id="padecimientosPersonales" placeholder="Ingrese los padecimientos personales del paciente..." name="padecimientosPersonales" rows="4" cols="50"><%= expedienteEncontrado.getPadecimientoPersonales()%></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select id="tipoSangre" name="tipoSangre" value="<%= expedienteEncontrado.getTipoSangre()%>">
                                    <option value="seleccione">Seleccione el tipo de sangre</option>
                                    <%
                                        if (expedienteEncontrado.getTipoSangre().equalsIgnoreCase("O-")) {
                                    %>
                                    ...
                                    <%
                                        ...
                                        if (expedienteEncontrado.getTipoSangre().equalsIgnoreCase("A-")) {
                                    %>
                                    ...
                                    <%
                                        ...
                                        if (expedienteEncontrado.getTipoSangre().equalsIgnoreCase("B-")) {
                                    %>
                                    ...
                                    <%
                                        ...
                                        if (expedienteEncontrado.getTipoSangre().equalsIgnoreCase("AB-")) {
                                    %>
                            ...
                            <div class="col">
                                ...
                                <select id="alergias" name="alergias" value="<%= expedienteEncontrado.getAlergias()%>">
                                    <option value="seleccione">Seleccione opción</option>
                                    <%
                                        if (expedienteEncontrado.getAlergias().equalsIgnoreCase("si")) {
                                    %>
                                    ...
                                    <%
                                        ...
                                        if (expedienteEncontrado.getAlergias().equalsIgnoreCase("no")) {
                                    %>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" id="estatura" name="estatura" pattern="[0-9]+(\.[0-9]{1,2})?" placeholder="0.00" value="<%= expedienteEncontrado.getEstatura()%>" required>
                            </div>
                            <div class="col">
                                <label for="peso">Peso (kilos):</label>
                                <input type="text" id="peso" name="peso" pattern="[0-9]{1,3}(\.[0-9]{1,2})?" placeholder="00.0" value="<%= expedienteEncontrado.getPeso()%>" required>
                            </div>
                            <div class="col">
                                <label for="frecuenciaCardiaca">Frecuencia Cardiaca (bpm):</label>
                                <input type="text" id="frecuenciaCardiaca" name="frecuenciaCardiaca" pattern="[0-9]{1,3}" placeholder="00" value="<%= expedienteEncontrado.getFrecuenciaCardiaca()%>" required>
                            </div>
                        </div>
                    </div>
                </form>
